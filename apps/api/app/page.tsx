...
const groups = [
  {
    ...
    endpoints: [
      ...
      ["GET", "/api/v0/mogs?awake=true", "Awakened Mog metadata feed."],
  ...
  },
  {
    ...
    endpoints: [
      ...
      ["GET", "/api/agents/search", "Search awakened agents by token, agent, wallet, rarity, or name."],
      ["GET", "/api/agents/binding/{mogId}", "Normies-style binding lookup by Mog ID."],
      ["POST", "/api/agents/binding/batch", "Batch binding lookup for Mog IDs."],
      ...
      ["GET", "/api/agents/identity/{mogId}", "Mog identity plus awakened agent status."],
      ["GET", "/api/agents/persona-preview/{mogId}", "Deterministic persona preview without requiring awakening."],
      ...
      ["GET", "/api/agents/by-agent-id/{agentId}", "Resolve a bound Mog from an ERC-8004 agent ID."],
      ["GET", "/api/agents/by-agent-id/{agentId}/info", "Persona-rich agent info by ERC-8004 agent ID."],
